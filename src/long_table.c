...
void tests() {
    ...
    assert(long_table_find(table, 0x69) == NULL);
    long_table_remove(table, 0x99);
    assert(long_table_find(table, 0x99) == NULL);

    long_table_free(table);
